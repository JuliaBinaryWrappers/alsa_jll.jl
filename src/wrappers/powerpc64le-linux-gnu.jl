...
function __init__()
    ...
    global libasound_path = abspath(joinpath(artifact"alsa", libasound_splitpath...))
    ...
    global libatopology_path = abspath(joinpath(artifact"alsa", libatopology_splitpath...))
